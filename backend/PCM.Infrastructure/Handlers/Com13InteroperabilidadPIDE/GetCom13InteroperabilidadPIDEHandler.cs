    ...
    public async Task<Result<Com13InteroperabilidadPIDEResponse>> Handle(GetCom13InteroperabilidadPIDEQuery request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            var response = new Com13InteroperabilidadPIDEResponse
            {
                ...
                // Campos específicos PIDE
                TipoIntegracionPide = entity.TipoIntegracionPide,
                NombreServicioPide = entity.NombreServicioPide,
                DescripcionServicioPide = entity.DescripcionServicioPide,
                FechaInicioOperacionPide = entity.FechaInicioOperacionPide,
                ResponsablePide = entity.ResponsablePide,
                CargoResponsablePide = entity.CargoResponsablePide,
                CorreoResponsablePide = entity.CorreoResponsablePide,
                TelefonoResponsablePide = entity.TelefonoResponsablePide,
                NumeroConvenioPide = entity.NumeroConvenioPide,
                FechaConvenioPide = entity.FechaConvenioPide,
                InteroperabilidadPide = entity.InteroperabilidadPide,
                UrlServicioPide = entity.UrlServicioPide,

...
namespace PCM.Application.Features.Com8PublicacionTUPA.Queries.GetCom8PublicacionTUPA;

public class GetCom8PublicacionTUPAQuery : IRequest<Result<Com8PublicacionTUPAResponse>>
{

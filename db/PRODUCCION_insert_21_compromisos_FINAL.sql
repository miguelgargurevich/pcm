-- =====================================================
-- SCRIPT FINAL PARA PRODUCCIÓN (SUPABASE)
-- Fecha: 22 de Noviembre 2025
-- Descripción: 
-- 1. Asegura estructura de alcance_compromisos (FK faltante)
-- 2. Asegura clasificaciones necesarias
-- 3. Inserta los 21 compromisos
-- 4. Inserta los alcances
-- =====================================================
...
INSERT INTO clasificacion (nombre, activo) VALUES
('Gobierno Nacional', true),
('Gobierno Regional', true),
('Gobierno Local', true)
...
-- Insertar alcances calculando el ID manualmente (ya que no tiene default en PROD)

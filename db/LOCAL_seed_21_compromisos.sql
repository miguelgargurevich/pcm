-- Script para LOCAL: Insertar los 21 compromisos
...
-- LOCAL usa alcance_compromiso_id con SERIAL (auto-increment)
...
SELECT compromiso_id, nombre_compromiso, estado, activo 
...
SELECT 
    'alcance_compromisos',
    COUNT(*)
FROM alcance_compromisos ac
JOIN compromiso_gobierno_digital c ON ac.compromiso_id = c.compromiso_id
WHERE c.compromiso_id BETWEEN 1 AND 21;

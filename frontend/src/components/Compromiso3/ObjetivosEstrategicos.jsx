  ...
  return (
    <div className="space-y-3">
      <div className="flex justify-between items-center">
        <h3 className="text-base font-semibold text-gray-800">Objetivos Estratégicos</h3>
        {!viewMode && (
          <button
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col">
            ...
            <div className="flex items-center justify-between p-6 border-b bg-gradient-to-r from-primary-600 to-primary-700 rounded-t-xl text-white">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold">{editingObjetivo ? 'Editar Objetivo' : 'Nuevo Objetivo'}</h2>
                  <p className="text-sm text-white/80">Objetivos estratégicos</p>
                </div>
              </div>
              <button

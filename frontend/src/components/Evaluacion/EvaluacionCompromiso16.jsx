 ...
 */
const EvaluacionCompromiso16 = ({ data, activeTab }) => {
  if (!data) {
    return (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-teal-50 rounded-lg p-4 border border-teal-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="text-xs text-gray-500 flex items-center gap-1"><Activity size={12} /> Estado de Implementación</label>
              ...
              <div>
                <label className="text-xs text-gray-500 flex items-center gap-1"><Target size={12} /> Alcance del SGSI</label>
...
EvaluacionCompromiso16.propTypes = { data: PropTypes.object, activeTab: PropTypes.string.isRequired };

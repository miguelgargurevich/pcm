          ...
          <div className="bg-amber-50 rounded-lg p-4 border border-amber-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="md:col-span-3">
                <label className="text-xs text-gray-500">Nombre del CSIRT</label>
                <p className="text-gray-900 font-medium text-lg">{d.nombreCsirt || '-'}</p>
              </div>
              <div>
                <label className="text-xs text-gray-500 flex items-center gap-1"><Hash size={12} /> Número de Resolución</label>
                <p className="text-gray-900">{d.numeroResolucion || '-'}</p>
              </div>
              <div>
                <label className="text-xs text-gray-500 flex items-center gap-1"><Calendar size={12} /> Fecha de Conformación</label>

...
import { FileText, User, Mail, Phone, CreditCard, Briefcase, Database } from 'lucide-react';

/**
 * Compromiso 21: Oficial de Gobierno de Datos
 */
const EvaluacionCompromiso21 = ({ data, activeTab }) => {
  if (!data) {
    return (
  ...
  const d = {
    ...
    nombre: data.nombreOgd || data.NombreOgd || '',
...
EvaluacionCompromiso21.propTypes = { data: PropTypes.object, activeTab: PropTypes.string.isRequired };

                ...
                {obj.acciones && obj.acciones.length > 0 && (
                  <div className="mt-2 pl-4 border-l-2 border-blue-200">
                    ...
                    {obj.acciones.map((acc, accIndex) => (
                      <div key={acc.accObjEntId || accIndex} className="flex items-center gap-2 text-sm text-gray-600">
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
        <div className="bg-gray-50 rounded-lg p-3">
          <label className="text-xs text-gray-500">Ubicación Área TI</label>
        ...
        <div className="bg-gray-50 rounded-lg p-3">
          <label className="text-xs text-gray-500">Costo Anual TI</label>
          ...
          <table className="min-w-full divide-y divide-gray-200 border rounded-lg">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Instalaciones</th>
                <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Licencias</th>
          ...
          <table className="min-w-full divide-y divide-gray-200 border rounded-lg">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Tipo</th>
                <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Lenguaje</th>
                <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">BD</th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
          ...
          <table className="min-w-full divide-y divide-gray-200 border rounded-lg">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Puertos Op.</th>
                <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Puertos Inop.</th>
                <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Total Puertos</th>
                <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Costo Mant.</th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
          ...
          <table className="min-w-full divide-y divide-gray-200 border rounded-lg">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">RAM (GB)</th>
                <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Costo Mant.</th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
          ...
          <div className="mt-4">
            ...
            <div className="space-y-2">
              {seguridadInfo.capacitaciones.map((cap, i) => (
                <div key={cap.capsegId || i} className="flex items-center justify-between p-2 bg-blue-50 rounded-lg">
          ...
          <div className="mt-4 p-4 bg-blue-50 rounded-lg">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
              <div className="text-center">
                ...
                <div className="text-xs text-blue-600">Objetivos PEI</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-700">{objetivosGD.length}</div>
                <div className="text-xs text-blue-600">Objetivos GD</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-700">{personalTI.length}</div>
                <div className="text-xs text-blue-600">Personal TI</div>
              </div>
              <div className="text-center">
